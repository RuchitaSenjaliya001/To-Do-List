    ...
    return (
        <form onSubmit={submitHandler}>
            <div className="flex max-w-6xl m-auto border justify-between px-5 items-center shadow-lg my-5" style={{borderColor: !isValid ? 'red' : ''}}>
                ...
                <div>
                <input type="date" name="date" id="date" className='pr-4 focus:outline-none bg-transparent' onChange={dateChangeHandler} value={enteredDate} style={{borderColor: !isValid ? 'red' : ''}}/>
